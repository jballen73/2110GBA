...
OFILES = gba.o font.o logic.o graphics.o main.o images/sprites.o images/basicScreen.o images/jumpScreen.o images/tallObstacleScreen.o images/saveScreen.o
